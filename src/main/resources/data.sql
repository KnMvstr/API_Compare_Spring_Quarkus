...
VALUES ('Sedan'), ('SUV'), ('Hatchback'), ('Convertible'), ('Coupe');

-- Insert engine --
INSERT INTO engine (name, power, fuel_type)
VALUES ('1.6L', '120hp', 1), -- Assuming '1' corresponds to GASOLINE
       ('2.0L', '150hp', 1), ('2.2L', '180hp', 5), ('2.6L', '180hp', 0),
       ('3.0L', '250hp', 5), ('2.1L', '200hp', 3), ('1.5L Hybrid', '130hp', 6),
       ('2.5L', '200hp', 4), ('80kW', '150hp', 2), ('3.3L', '280hp', 0),
       ('3.5L', '300hp', 1), ('4.0L Turbo', '400hp', 1),
       ('2.0L Turbo Hybrid', '220hp', 6), ('200kW', '270hp', 2);

-- Insert color RVB et HEX --
INSERT INTO color (name, rvb_ref, hex_ref)
VALUES ('Black', '0,0,0', '#000000'), ('White', '255,255,255', '#FFFFFF'),
...
-- Insert models into the model table
...
SELECT model, brand_id,
       CASE
           ...
           WHEN model IN ('Prius', 'Fit', 'Malibu', 'Q5', 'X5', 'Outback', 'Forester', 'Crosstrek', 'Impreza', 'Legacy') THEN 5
